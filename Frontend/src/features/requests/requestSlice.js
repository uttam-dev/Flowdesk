...
export const fetchRequests = createAsyncThunk(
  ...
  async (params, { getState, rejectWithValue }) => {
    ...
    try {
      if (s.activeTab === "team") {
        return await fetchTeamRequestsApi(p);
      }
...
export const selectRequestNumberFilter = (state) =>
  state.requests.requestNumber;
export const selectRequestActiveTab = (state) => state.requests.activeTab;
export const selectRequestMutationLoading = (state) =>
  state.requests.mutationLoading;
export const selectRequestDetail = (state) => state.requests.detail;
export const selectRequestDetailLoading = (state) =>
  state.requests.detailLoading;
...
export const selectRequestCommentsLoading = (state) =>
  state.requests.commentsLoading;

    ...
    <div className={`flex w-full flex-col gap-1.5 text-left ${className}`}>
      ...
      <div className="relative w-full">
        ...
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center justify-center px-3 text-gray-500 transition hover:text-gray-700 disabled:cursor-not-allowed disabled:opacity-50"
        >
          {showPassword ? (
            // Eye-off icon
            <svg
